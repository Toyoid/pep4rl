...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subPose = nh.subscribe<nav_msgs::Odometry> ("/falco_planner/state_estimation", 5, poseHandler);
  ...
  ros::Publisher pubSpeed = nh.advertise<std_msgs::Float32> ("/falco_planner/speed", 5);
