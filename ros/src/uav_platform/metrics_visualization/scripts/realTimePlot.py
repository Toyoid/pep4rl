...
def listener():
  ...
  rospy.Subscriber("/data_recording/time_duration", Float32, timeDurationCallback)
  rospy.Subscriber("/data_recording/runtime", Float32, runTimeCallback)
  rospy.Subscriber("/data_recording/explored_volume", Float32, exploredVolumeCallback)
  rospy.Subscriber("/data_recording/traveling_distance", Float32, travelingDistanceCallback)
...
#   fig3.set_yticks([0.02, 0.04, 0.06, 0.08, 0.1])
