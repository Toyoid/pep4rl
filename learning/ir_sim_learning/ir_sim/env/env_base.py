...
class EnvBase:
    ...
    def __init__(self, world_name=None, control_mode='auto', collision_mode='stop', 
        ...
        custom_robot=None, subplot=True, **kwargs) -> None:
        ...
        full: True or false to whether show the figure full screen
        custom_robot: custom robot class for user;
        subplot: whether there are subplot
        '''
    ...
    def render(self, pause_time=0.02, fig_kwargs=dict(), **kwargs):
        ...
        if not self.disable_all_plot: 
            if self.world.sampling:
                ...
                if self.save_ani:
                    self.save_gif_figure(bbox_inches=self.bbox_inches, dpi=self.ani_dpi, **fig_kwargs)
